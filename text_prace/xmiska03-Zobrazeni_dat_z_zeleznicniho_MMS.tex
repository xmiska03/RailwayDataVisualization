...
\projectinfo{
  ...
  keywords.cs={vizualizácia dát, mračno bodov, Python, Pydeck, používateľské rozhranie, webové aplikácie, Dash}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={data visualization, point cloud, Python, Pydeck, user interface, web aplications, Dash}, % klíčová slova v anglickém jazyce / keywords in english
