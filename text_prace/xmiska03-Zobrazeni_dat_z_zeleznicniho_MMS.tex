...
\projectinfo{
  ...
  keywords.cs={vizualizácia dát, používateľské rozhranie, mračno bodov, mobilné mapovanie, 3D grafika}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={data visualization, user interface, point cloud, mobile mapping, 3D graphics}, % klíčová slova v anglickém jazyce / keywords in english
