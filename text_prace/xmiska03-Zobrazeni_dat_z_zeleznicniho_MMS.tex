...
\projectinfo{
  ...
  keywords.cs={vizualizácia dát, mračno bodov, Python, deck.gl, webové aplikácie, Dash}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={data visualization, point cloud, Python, deck.gl, web aplications, Dash}, % klíčová slova v anglickém jazyce / keywords in english
