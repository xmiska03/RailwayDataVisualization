...
visualization_tab = [
    ...
    dbc.Row(html.Hr()),
    dbc.Row(html.Div("Mračno bodů", style={"font-weight": "bold", "text-align": "center", "padding-bottom": "0.5em",})),
    ...
    dbc.Placeholder(color="black", size="xs"),
    dbc.Row(html.Hr()),
    dbc.Row(html.Div("Vektorová data", style={"font-weight": "bold", "text-align": "center", "padding-bottom": "0.5em",})),
